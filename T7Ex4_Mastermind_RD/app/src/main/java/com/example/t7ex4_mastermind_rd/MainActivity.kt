package com.example.t7ex4_mastermind_rd
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val secMaster = mm.child("numSecret")
            ...
            object : ValueEventListener {
                ...
                fun onDataChange(dataSnapshot: DataSnapshot) {
                    if (dataSnapshot.getValue() == null || dataSnapshot.child("finalitzada").getValue() as Boolean) {
                        ...
                        secret = dataSnapshot.child("numSecret").getValue() as String
                    }
                }
                ...
                object : ValueEventListener {
                    ...
                    fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.child("finalitzada").getValue() as Boolean) {
                            ...
                            secret = genera()
                            mm.child("numSecret").setValue(secret, null)
